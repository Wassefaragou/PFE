...
def load_app_state() -> dict:
    ...
    transactions_validated, transaction_issues = validate_transactions(transactions_raw, contracts_priced)
    ...
    return {
        ...
        "contracts_priced": contracts_priced,
